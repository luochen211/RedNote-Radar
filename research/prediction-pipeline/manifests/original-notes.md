...
The following notes are a direct cleanup of the legacy local
`1.预测页代码与部分分析页代码/readme.txt`.
...
2. 提取视频帧特征
   - Script: `feature_extraction/step-2-extract-video-frame-features.py`

### 音频处理
1. 从视频提取背景音频
   - Script: `feature_extraction/step-3-extract-audio-from-video.py`
2. 提取音频特征
   - Script: `feature_extraction/step-4-extract-audio-features.py`
