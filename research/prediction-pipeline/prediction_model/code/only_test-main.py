...
parser.add_argument('--epoch_stop', type=int, default=20) #10 #20/50/100
parser.add_argument('--seed', type=int, default=2022)
parser.add_argument('--gpu', type=int, default=0)
parser.add_argument('--lr', type=float, default=0.00001)    #0.1/0.01/0.001c
